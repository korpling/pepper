...
public class XsltModulesSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case XsltModulesPackage.PEPPER_XSLT_EXPORTER: {
				PepperXSLTExporter pepperXSLTExporter = (PepperXSLTExporter)theEObject;
				T result = casePepperXSLTExporter(pepperXSLTExporter);
				if (result == null) result = casePepperExporter(pepperXSLTExporter);
				if (result == null) result = casePepperModule(pepperXSLTExporter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case XsltModulesPackage.XSLT_TRANSFORMER: {
				XSLTTransformer xsltTransformer = (XSLTTransformer)theEObject;
				T result = caseXSLTTransformer(xsltTransformer);
				if (result == null) result = casePersistenceConnector(xsltTransformer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Pepper XSLT Exporter</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Pepper XSLT Exporter</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePepperXSLTExporter(PepperXSLTExporter object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>XSLT Transformer</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>XSLT Transformer</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseXSLTTransformer(XSLTTransformer object) {
		return null;
	}
