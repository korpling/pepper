...
public class XsltModulesAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected XsltModulesSwitch<Adapter> modelSwitch =
		new XsltModulesSwitch<Adapter>() {
			@Override
			public Adapter casePepperXSLTExporter(PepperXSLTExporter object) {
				return createPepperXSLTExporterAdapter();
			}
			@Override
			public Adapter caseXSLTTransformer(XSLTTransformer object) {
				return createXSLTTransformerAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.hu_berlin.german.korpling.saltnpepper.pepper.pepperModules.xsltModules.PepperXSLTExporter <em>Pepper XSLT Exporter</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.hu_berlin.german.korpling.saltnpepper.pepper.pepperModules.xsltModules.XSLTTransformer <em>XSLT Transformer</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
