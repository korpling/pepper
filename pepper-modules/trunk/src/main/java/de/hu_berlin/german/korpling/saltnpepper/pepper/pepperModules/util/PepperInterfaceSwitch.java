 ...
 * <!-- end-user-doc -->
 * @see de.hu_berlin.german.korpling.saltnpepper.pepper.pepperModules.PepperInterfacePackage
 * @generated
 */
public class PepperInterfaceSwitch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static PepperInterfacePackage modelPackage;
	 ...
	 * @generated
	 */
	public PepperInterfaceSwitch() {
		if (modelPackage == null) {
			modelPackage = PepperInterfacePackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PepperInterfacePackage.PEPPER_EXPORTER: {
			...
			case PepperInterfacePackage.PEPPER_MANIPULATOR: {
			...
			case PepperInterfacePackage.EXTENSION_FACTORY_PAIR: {
			...
			case PepperInterfacePackage.PERSISTENCE_CONNECTOR: {
