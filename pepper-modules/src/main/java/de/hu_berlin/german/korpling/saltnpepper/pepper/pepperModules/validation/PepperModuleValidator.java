...
/**
 * A sample validator interface for {@link de.hu_berlin.german.korpling.saltnpepper.pepper.pepperModules.PepperModule}.
...
public interface PepperModuleValidator {
	...
	boolean validatePepperModuleController(PepperModuleController value);

	boolean validateSaltProject(SaltProject value);

	boolean validateReturningMode(RETURNING_MODE value);
}
