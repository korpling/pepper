...
public class PepperModulesPackageImpl extends EPackageImpl implements PepperModulesPackage {
	 ...
	 * @see de.hu_berlin.german.korpling.saltnpepper.pepper.pepperModules.PepperModulesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private PepperModulesPackageImpl() {
		super(eNS_URI, PepperModulesFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link PepperModulesPackage#eINSTANCE} when that field is accessed.
	...
	public static PepperModulesPackage init() {
		if (isInited) return (PepperModulesPackage)EPackage.Registry.INSTANCE.getEPackage(PepperModulesPackage.eNS_URI);

		// Obtain or create and register package
		PepperModulesPackageImpl thePepperModulesPackage = (PepperModulesPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof PepperModulesPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new PepperModulesPackageImpl());
		...
		thePepperModulesPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(PepperModulesPackage.eNS_URI, thePepperModulesPackage);
		return thePepperModulesPackage;
	}
