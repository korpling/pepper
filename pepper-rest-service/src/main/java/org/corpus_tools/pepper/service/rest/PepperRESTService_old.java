...
//public class PepperRESTService_old implements PepperService, PepperServiceImplConstants{
//		
//	/* statics */
//	private static Pepper pepper;
//	private static PepperSerializer serializer = PepperSerializer.getInstance(DATA_FORMAT);
//	
//	private static final Logger logger = LoggerFactory.getLogger(PepperRESTService_old.class);
//	
