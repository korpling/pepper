...
public class TestManipulator1 extends PepperManipulatorImpl 
{
	public TestManipulator1() 
	{
		super.name=getModuleName();
		this.setSymbolicName(this.getName());
	}
	
	public static String name= "TestManipulator1";
