...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>pepperFW</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class PepperFWExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(PepperFWPackage.eNS_URI, 
			 PepperFWPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.pepperfw"));
				PepperConverter root = PepperFWFactory.eINSTANCE.createPepperConverter();
