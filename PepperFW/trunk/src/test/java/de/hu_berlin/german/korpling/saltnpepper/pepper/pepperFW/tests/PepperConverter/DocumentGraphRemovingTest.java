 ...
 */
public class DocumentGraphRemovingTest extends TestCase 
{
	/**
	...
	public static void main(String[] args) {
		TestRunner.run(DocumentGraphRemovingTest.class);
	}
	 ...
	 *
	 */
	public DocumentGraphRemovingTest(String name) {
		super(name);
	}
	...
	/**
	 * Tests if a documentgraph will be removed from a document, after it was processed by all modules.
...
//		System.out.println(this.getFixture().getPepperDocumentController().getStatus4Print());
	...
	/**
	 * Tests if a documentgraph will be removed from a document, after it was processed by all modules.
	 * This test contains one importer and two exporter. 
	 */
