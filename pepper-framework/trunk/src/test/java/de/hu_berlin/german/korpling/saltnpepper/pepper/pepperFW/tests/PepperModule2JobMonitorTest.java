 ...
 * @generated
 */
public class PepperModule2JobMonitorTest extends PepperMonitorTest {
	...
	public static void main(String[] args) {
		TestRunner.run(PepperModule2JobMonitorTest.class);
	}

	/**
	 * Constructs a new Pepper Module2 Job Monitor test case with the given name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public PepperModule2JobMonitorTest(String name) {
		super(name);
	}

	/**
	 * Returns the fixture for this Pepper Module2 Job Monitor test case.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
