...
/**
 * This class tests if the pepper frameworks sets the temprorary folder for every module correctly. 
 * It also tests if several modules of same class will get different folders.
 * <p>
 ...
 * </p>
 */
public class TemproraryFolderTest extends TestCase 
{
	/**
	...
	public static void main(String[] args) {
		TestRunner.run(TemproraryFolderTest.class);
	}
	 ...
	 *
	 */
	public TemproraryFolderTest(String name) {
		super(name);
	}
	...
	protected void setUp() throws Exception 
	{
		...
		usedTMPFolders= new BasicEList<URI>();
	}
	...
	public static class TestImporter extends PepperImporterImpl
	{
		...
		{
			assertNotNull(this.getTemproraries());
			assertTrue(this.getTemproraries().isFile());
			assertFalse(usedTMPFolders.contains(this.getTemproraries()));
			usedTMPFolders.add(this.getTemproraries());
		}
	 ...
	 */
	private static EList<URI> usedTMPFolders= null;
	
	/**
	 * Checks for one importer, one exporter and one manipulator, if everyone has a disjunct tmp-folder.
	 * @throws IOException 
...
//	}
	...
	/**
	 * Checks for two importers, two exporter and two manipulator of same type, if everyone has a disjunct tmp-folder.
	 * @throws IOException 
	 * @throws IllegalAccessException 
	 * @throws InstantiationException 
	 *
