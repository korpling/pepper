 ...
 * <ul>
 *   <li>{@link de.hu_berlin.german.korpling.saltnpepper.pepper.pepperFW.PepperQueuedMonitor#put(de.hu_berlin.german.korpling.saltnpepper.salt.saltCore.SElementId) <em>Put</em>}</li>
 *   <li>{@link de.hu_berlin.german.korpling.saltnpepper.pepper.pepperFW.PepperQueuedMonitor#get() <em>Get</em>}</li>
 * </ul>
 * </p>
 * @generated
 */
public class PepperQueuedMonitorTest extends PepperMonitorTest {
	...
	public static void main(String[] args) {
		TestRunner.run(PepperQueuedMonitorTest.class);
	}

	/**
	 * Constructs a new Pepper Queued Monitor test case with the given name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public PepperQueuedMonitorTest(String name) {
		super(name);
	}

	/**
	 * Returns the fixture for this Pepper Queued Monitor test case.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
