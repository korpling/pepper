 ...
 *
 */
package de.hu_berlin.german.korpling.saltnpepper.pepper.modules.text.tests;
...
public class TextImporterTest extends PepperImporterTest {
	...
	/**
	 * Tests the import of a single txt file containing characters linebreaks and tabs.
