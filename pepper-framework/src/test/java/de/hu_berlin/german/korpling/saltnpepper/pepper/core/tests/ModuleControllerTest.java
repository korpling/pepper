...
public class ModuleControllerTest{
	...
	/**
	 * Tests if method {@link ModuleControllerImpl#toString()} returns a non empty string 
	 */
	 @Test
	 ...
	 /**
	  * Tests the method {@link ModuleControllerImpl#complete(de.hu_berlin.german.korpling.saltnpepper.pepper.core.DocumentController)}
	  */
	 @Test
