...
public class SaltXMLExporter extends PepperExporterImpl implements PepperExporter {
	...
	public SelfTestDesc getSelfTestDesc() {
		final URI basePath = getResources().appendSegment("modules").appendSegment("selfTests")
				.appendSegment("saltXmlExporter");
		final URI inputCorpusPath = basePath.appendSegment("in");
