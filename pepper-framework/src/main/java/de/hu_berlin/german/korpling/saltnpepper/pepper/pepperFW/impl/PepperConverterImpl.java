 ...
 * <em><b>Pepper Converter</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link de.hu_berlin.german.korpling.saltnpepper.pepper.pepperFW.impl.PepperConverterImpl#getPepperModuleResolver
 * <em>Pepper Module Resolver</em>}</li>
 * <li>
 * {@link de.hu_berlin.german.korpling.saltnpepper.pepper.pepperFW.impl.PepperConverterImpl#getPepperParams
 * <em>Pepper Params</em>}</li>
 * <li>
 * {@link de.hu_berlin.german.korpling.saltnpepper.pepper.pepperFW.impl.PepperConverterImpl#getPepperJobs
 * <em>Pepper Jobs</em>}</li>
 * <li>
 * {@link de.hu_berlin.german.korpling.saltnpepper.pepper.pepperFW.impl.PepperConverterImpl#getPepperJ2CMonitors
 * <em>Pepper J2C Monitors</em>}</li>
 * <li>
 * {@link de.hu_berlin.german.korpling.saltnpepper.pepper.pepperFW.impl.PepperConverterImpl#isParallelized
 * <em>Parallelized</em>}</li>
 * <li>
 * {@link de.hu_berlin.german.korpling.saltnpepper.pepper.pepperFW.impl.PepperConverterImpl#getProperties
 * <em>Properties</em>}</li>
 * <li>
 * {@link de.hu_berlin.german.korpling.saltnpepper.pepper.pepperFW.impl.PepperConverterImpl#getPepperParamsURI
 * <em>Pepper Params URI</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class PepperConverterImpl extends EObjectImpl implements PepperConverter {
    /**
     * The cached value of the '{@link #getPepperModuleResolver()
     * <em>Pepper Module Resolver</em>}' containment reference. <!--
    ...
    /**
     * This is true if the Pepper Module Resolver containment reference has been
    ...
    /**
     * The default value of the '{@link #getPepperParams()
     * <em>Pepper Params</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getPepperParams()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getPepperParams()
     * <em>Pepper Params</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getPepperParams()
    ...
    /**
     * The cached value of the '{@link #getPepperJobs() <em>Pepper Jobs</em>}'
    ...
    /**
     * The cached value of the '{@link #getPepperJ2CMonitors()
     * <em>Pepper J2C Monitors</em>}' containment reference list. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * The default value of the '{@link #isParallelized() <em>Parallelized</em>}
    ...
    /**
     * The cached value of the '{@link #isParallelized() <em>Parallelized</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #isParallelized()
     * @generated
    ...
    /**
     * The default value of the '{@link #getPepperParamsURI()
     * <em>Pepper Params URI</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getPepperParamsURI()
     * <em>Pepper Params URI</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getPepperParamsURI()
    ...
    // ========================================== start: LogService
    /**
     * Static logger, which is initialized, when the first
     * {@link PepperConverterImpl} is created. The same object as set to that
     * object, is set to the static {@link LogService}. One can get the static
     * {@link LogService} via
     */
     ...
     * @generated
     */
    public NotificationChain basicSetPepperModuleResolver(
	    PepperModuleResolver newPepperModuleResolver, NotificationChain msgs) {
	...
	if (eNotificationRequired()) {
	    ENotificationImpl notification = new ENotificationImpl(this,
		    Notification.SET,
		    PepperFWPackage.PEPPER_CONVERTER__PEPPER_MODULE_RESOLVER,
		    oldPepperModuleResolver, newPepperModuleResolver,
		    !oldPepperModuleResolverESet);
	    if (msgs == null)
		msgs = notification;
	    else
	...
	if (newPepperModuleResolver != pepperModuleResolver) {
		...
		msgs = ((InternalEObject) newPepperModuleResolver)
			.eInverseAdd(
				this,
				EOPPOSITE_FEATURE_BASE
					- PepperFWPackage.PEPPER_CONVERTER__PEPPER_MODULE_RESOLVER,
		...
		eNotify(new ENotificationImpl(
			...
			Notification.SET,
			PepperFWPackage.PEPPER_CONVERTER__PEPPER_MODULE_RESOLVER,
			newPepperModuleResolver, newPepperModuleResolver,
			!oldPepperModuleResolverESet));
	}
    }
     ...
     * @generated
     */
    public NotificationChain basicUnsetPepperModuleResolver(
	...
	if (eNotificationRequired()) {
	    ENotificationImpl notification = new ENotificationImpl(this,
		    Notification.UNSET,
		    PepperFWPackage.PEPPER_CONVERTER__PEPPER_MODULE_RESOLVER,
		    oldPepperModuleResolver, null, oldPepperModuleResolverESet);
	    if (msgs == null)
		msgs = notification;
	    else
		msgs.add(notification);
	...
	if (pepperModuleResolver != null) {
		...
		eNotify(new ENotificationImpl(
			...
			Notification.UNSET,
			PepperFWPackage.PEPPER_CONVERTER__PEPPER_MODULE_RESOLVER,
			null, null, oldPepperModuleResolverESet));
	}
    }

    /**
     * {@inheritDoc PepperConverter#selfTest()}
     */
    @Override
	...
	Collection<PepperImporter> importers = this.getPepperModuleResolver()
		.getPepperImporters();
	if ((importers == null) || (importers.size() == 0)) {
		...
		try {
		    System.out.println("Checking '"+importer.getName()+"'");
	...
	Collection<PepperManipulator> manipulators = this.getPepperModuleResolver()
		.getPepperManipulators();
	if ((manipulators != null) && (manipulators.size() != 0)) {
	    for (PepperManipulator manipulator : manipulators) {
		try {
		    System.out.println("Checking '"+manipulator.getName()+"'");
	...
	Collection<PepperExporter> exporters = this.getPepperModuleResolver()
		.getPepperExporters();
	if ((exporters == null) || (exporters.size() == 0)) {
		...
		try {
		    System.out.println("Checking '"+exporter.getName()+"'");
    ...
    /**
     * Checks the given parameters and throws an exception, if there is an
     * incorrect entry. Also completes pathes if necessary and possible.
     * 
     * @param pepperParams
     */
	...
	if ((pepperParams.getPepperJobParams() == null)
	    ...
	    throw new PepperParamsException(
		    "Cannot set parameter to PepperConverter, because no pepperParams are given.");
	for (PepperJobParams jobParams : pepperParams.getPepperJobParams()) {
	    // cheking if every job isn't null
	    if (jobParams == null)
		throw new PepperParamsException(
			"Cannot set parameter to PepperConverter, because one of given jobs is null.");
	    // checking if job has an id
	    if (jobParams.getId() == null)
		throw new PepperParamsException(
			"Cannot set parameter to PepperConverter, because the id of one of the jobs is null.");
	    {// checking if at least one importer is given
		if ((jobParams.getImporterParams() == null)
			|| (jobParams.getImporterParams().size() < 1))
		    throw new PepperParamsException(
			    "Cannot set parameter to PepperConverter, because no importer is given.");
		// checking importers
		for (ImporterParams importerParams : jobParams
			.getImporterParams()) {
		    if (importerParams == null)
			throw new PepperParamsException(
				"Cannot set parameter to PepperConverter, because one of the importers is null.");
		    if (((importerParams.getModuleName() == null) || (importerParams
			    .getModuleName().isEmpty()))
			    && (((importerParams.getFormatName() == null) || (importerParams
				    .getFormatName().isEmpty())) || ((importerParams
				    .getFormatVersion() == null) || (importerParams
				    .getFormatName().isEmpty()))))
			throw new PepperParamsException(
				"Cannot set parameter to PepperConverter, because one of the importers does neither have a name nor a format description (format name and format version).");
		}
	    }
		...
		if ((jobParams.getExporterParams() == null)
		    ...
		    throw new PepperParamsException(
			    "Cannot set parameter to PepperConverter, because no exporter is given.");
		// checking importers
		for (ExporterParams exporterParams : jobParams
			.getExporterParams()) {
		    if (exporterParams == null)
			throw new PepperParamsException(
				"Cannot set parameter to PepperConverter, because one of the exporters is null.");
		    if (((exporterParams.getModuleName() == null) || (exporterParams
			    .getModuleName().isEmpty()))
			    && (((exporterParams.getFormatName() == null) || (exporterParams
				    .getFormatName().isEmpty())) || ((exporterParams
				    .getFormatVersion() == null) || (exporterParams
				    .getFormatName().isEmpty()))))
			throw new PepperParamsException(
				"Cannot set parameter to PepperConverter, because one of the exporters does neither have a name nor a format description (format name and format version).");
		}
	    }
		...
		for (ModuleParams moduleParams : jobParams.getModuleParams()) {
			...
			throw new PepperParamsException(
				"Cannot set parameter to PepperConverter, because one of the modules is null.");
		    if ((moduleParams.getModuleName() == null)
			    && (moduleParams.getModuleName().isEmpty()))
			throw new PepperParamsException(
				"Cannot set parameter to PepperConverter, because one of the modules has no name.");
		}
	    }
	    {// fullfill all pathes if necessary and possible
		if (this.getPepperParamsURI() != null) {// only if the path of
							// pepper-workflow
							// description is set
		    String errorPart = "";
		    URI errorURI = null;
		    try {
			for (ImporterParams importerParams : jobParams
				.getImporterParams()) {// check all uri
						       // parameters for
						       // importers
			    errorPart = "source path for importer";
			    errorURI = importerParams.getSourcePath();
			    importerParams.setSourcePath(this
				    .checkAndResolveURI(
					    this.getPepperParamsURI(),
					    importerParams.getSourcePath()));
			    errorPart = "special parameter for importer";
			    errorURI = importerParams.getSpecialParams();
			    if ((importerParams.getSpecialParams() != null)
				    && (!importerParams.getSpecialParams()
					    .toFileString().isEmpty())) {
				importerParams.setSpecialParams(this
					.checkAndResolveURI(this
						.getPepperParamsURI(),
						importerParams
							.getSpecialParams()));
			    }
			}// check all uri parameters for importers
			for (ModuleParams manipulatorParams : jobParams
				.getModuleParams()) {// check all uri parameters
						     // for manipulators
				...
				if ((manipulatorParams.getSpecialParams() != null)
				    ...
				    manipulatorParams
					    .setSpecialParams(this.checkAndResolveURI(
						    this.getPepperParamsURI(),
						    manipulatorParams
							    .getSpecialParams()));
				}
			...
			for (ExporterParams exporterParams : jobParams
				.getExporterParams()) {// check all uri
						       // parameters for
						       // exporters
			    ...
			    exporterParams
				    .setDestinationPath(this.checkAndResolveURI(
					    this.getPepperParamsURI(),
					    exporterParams.getDestinationPath()));
			    errorPart = "special parameter for exporter";
			    errorURI = exporterParams.getSpecialParams();
			    if ((exporterParams.getSpecialParams() != null)
				    && (!exporterParams.getSpecialParams()
					    .toFileString().isEmpty())) {
				exporterParams.setSpecialParams(this
					.checkAndResolveURI(this
						.getPepperParamsURI(),
						exporterParams
							.getSpecialParams()));
			...
			throw new PepperParamsException(
				"Cannot load pepper workflow description '"
					+ errorURI
					+ "', because file was not found for "
					+ errorPart
					+ ". Maybe an incorrect using of the URI syntax is the reason. Please use for instance 'file:/home/...', 'file:///home/...', 'file:/c:/...', or 'file:///c:/...' for absolute pathes and './a/b/c/' for relative pathes.",
				e);
		    }
    ...
    /**
     * The uri schemes, which are supported by usage in pepper workflow
     * descriptions.
     */
    public static final String[] supportedURISchemes = { "file" };

    /**
     * Checks if the scheme of the given {@link URI} objects is supported and
     * resolves the uris if possible.
     * <ul>
     * <li>If the uri <em>resolveURI</em> is absolute,
     * <ul>
     * <li>if the scheme of <em>resolveURI</em> is supported <em>resolveURI</em>
     * will be returned.</li>
     * <li>else a {@link PepperConvertException} will be thrown.</li>
     * </ul>
     * <li>If the uri <em>resolveURI</em> is relative,</li>
     * <ul>
     * <li>if the path of the uri <em>resolveURI</em> is absolute, it will be
     * returned.</li>
     * <li>if the path of the uri <em>resolveURI</em> is relative,</li>
     * <ul>
     * <li>if the <em>baseURI</em> is null a {@link PepperConvertException} will
     * be thrown.</li>
     * <li>the uri will be resolved against <em>baseURI</em>. If the scheme of
     * <em>baseURI</em> is not supported a {@link PepperConvertException} will
     * be thrown.</li>
     * </ul>
     * </ul> <li>If the uri <em>resolveURI</em> is null, null will be returned.</li>
     * </ul>
     * 
     * @param baseURI
     *            the base uri to resolve against the other one
     * @param resolveURI
     *            the uri to resolve
	...
	if (resolveURI != null) {
	    if (!resolveURI.isRelative()) {// resolveURI is absolute
					   // start: check if scheme of
					   // resolveURI is supported
		isSupported = false;
		...
		if (!isSupported)
		    throw new PepperConvertException("The scheme '"
			    + resolveURI.scheme() + "' of given resolve uri '"
			    + resolveURI + "' is not supported.");
		...
		if (resolveURI.path().startsWith("/")) {
			...
			throw new PepperConvertException(
				"Cannot resolve 'resolveURI' against 'baseURI', because given 'baseURI' is null.");
		    ...
		    if (!isSupported)
			throw new PepperConvertException("The scheme '"
				+ baseURI.scheme() + "' of given base uri '"
				+ baseURI + "' is not supported.");
	...
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET,
		    PepperFWPackage.PEPPER_CONVERTER__PEPPER_PARAMS,
		    oldPepperParams, pepperParams));
    }
	...
	if (pepperJobs == null) {
	    pepperJobs = new EObjectContainmentEList<PepperJob>(
		    PepperJob.class, this,
		    PepperFWPackage.PEPPER_CONVERTER__PEPPER_JOBS);
	}
	return pepperJobs;
    }
	...
	if (pepperJ2CMonitors == null) {
	    pepperJ2CMonitors = new EObjectContainmentEList<PepperFinishableMonitor>(
		    PepperFinishableMonitor.class, this,
		    PepperFWPackage.PEPPER_CONVERTER__PEPPER_J2C_MONITORS);
	}
	...
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET,
		    PepperFWPackage.PEPPER_CONVERTER__PARALLELIZED,
		    oldParallelized, parallelized));
    }
	...
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET,
		    PepperFWPackage.PEPPER_CONVERTER__PEPPER_PARAMS_URI,
		    oldPepperParamsURI, pepperParamsURI));
    }

    /**
     * Converts the given {@link java.net.URI} object to a {@link URI} object
     * pointing to a pepper workflow description and calls the method
     * {@link #setPepperParamsURI(URI)}.
     * 
     * @param pepperParamUri
     *            a uri (as {@link java.net.URI}) pointing to the file
     *            containing the pepper workflow description
     */
	...
	try {
	    ...
	    throw new PepperParamsException(
		    "An exception occured when converting the given uri '"
			    + pepperParamUri + "' into a emf uri.", e);
	}

    }

    /**
     * Reads the the given {@link URI} object pointing to a pepper workflow
     * description and creates a {@link PepperParams} object filled with the
     * content of the workflow description. After creating that
     * {@link PepperParams} object, the method
     * {@link #setPepperParams(PepperParams)} is called.
     * 
     * @param pepperParamUri
     *            a uri pointing to the file containing the pepper workflow
     *            description
     */
    public void setPepperParams(URI pepperParamUri) {
	if (pepperParamUri == null)
	    throw new PepperParamsException(
		    "Cannot set the pepper workflow description, because no uri was given.");
	...
	if (!file.exists())
	    throw new PepperException("Cannot read given pepperparams-file '"
		    + file.getAbsolutePath() + "', because it does not exist.");
	// this unnecessary variable must be initialized, because of the
	// initialization of the package (this is a workaround)
	@SuppressWarnings("unused")
	PepperParamsPackage pepperPackage = PepperParamsPackage.eINSTANCE;

	ResourceSet resourceSet = new ResourceSetImpl();
	resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap()
		.put("pepperparams", new XMIResourceFactoryImpl());
	Resource resource = resourceSet.createResource(pepperParamUri);

	if (resource == null)
	    throw new PepperException(
		    "Cannot read given pepperparams-file '"
			    + file.getAbsolutePath()
			    + "', because no resource was found. Please make sure, that file ends with '.pepperParams'.");
	try {
	    resource.load(null);
	} catch (IOException e) {
	    throw new PepperException(
		    "Cannot load pepper workflow description file '"
    ...
    /**
     * Creates a Pepper job out of the parameters for a job. It also creates a
     * lot of log messages to report an overview what has happend. <br/>
	...
	{// set PepperJobLogger to PepperJob
	    PepperJobLogger pepperJobLogger = PepperFWFactory.eINSTANCE
		    .createPepperJobLogger();
	...
	{// emit all importers and set them to job
		...
		if (this.logService != null) {
		    ...
		    this.logService.log(LogService.LOG_INFO,
			    "importer name:\t\t" + imParams.getModuleName());
		    this.logService.log(LogService.LOG_INFO, "source path:\t\t"
			    + imParams.getSourcePath());
		    this.logService.log(LogService.LOG_INFO, "format name:\t\t"
			    + imParams.getFormatName());
		    this.logService
			    .log(LogService.LOG_INFO, "format version:\t\t"
				    + imParams.getFormatVersion());
		}
		PepperImporter pepperImporter = this.getPepperModuleResolver()
			.getPepperImporter(imParams);
		if (pepperImporter == null) {
		    if (this.logService != null)
			this.logService
				.log(LogService.LOG_WARNING,
					"Cannot correct start job "
						+ jobParams.getId()
						+ ", because no importer was found for: "
						+ imParams);
		} else {
			...
			FormatDefinition formatDefinition = PepperFWFactory.eINSTANCE
				.createFormatDefinition();
			formatDefinition
				.setFormatName(imParams.getFormatName());
			formatDefinition.setFormatVersion(imParams
				.getFormatVersion());
			...
			if (imParams.getSpecialParams() != null) {
			    pepperImporter.setSpecialParams(imParams
				    .getSpecialParams());
			    setModuleProperties(pepperImporter,
				    imParams.getSpecialParams());
			}
		    }
		...
		if (this.logService != null) {
			...
			this.logService.log(
				LogService.LOG_INFO,
				"tmp folder:\t\t"
					+ pepperImporter.getTemproraries());
			this.logService.log(
				LogService.LOG_INFO,
				"resource folder:\t"
					+ pepperImporter.getResources());
			this.logService
				.log(LogService.LOG_INFO,
					"----------------------------------------------------");
		    }
	...
	if (pepperJob.getPepperImporters().size() < 1)
	    throw new PepperException(
		    "Cannot start job "
			    + jobParams.getId()
			    + ", because no importers were found for given pepper parameter: "
			    + jobParams);
	{// emit all manipulators and set them to job
		...
		PepperManipulator pepperManipulator = this
			.getPepperModuleResolver().getPepperManipulator(
				moduleParams);
		if (pepperManipulator == null) {
			...
			this.logService
				.log(LogService.LOG_WARNING,
					"Cannot correct start job "
						+ jobParams.getId()
						+ ", because no manipulator was found for: "
						+ moduleParams);
		} else {
		    pepperJob.getPepperModules().add(pepperManipulator);
		    {// setting special parameter
			if (moduleParams.getSpecialParams() != null) {
			    pepperManipulator.setSpecialParams(moduleParams
				    .getSpecialParams());
			    setModuleProperties(pepperManipulator,
				    moduleParams.getSpecialParams());
			}
		    }
		}
		if (this.logService != null) {
			...
			this.logService.log(
				LogService.LOG_INFO,
				"tmp folder:\t\t"
					+ pepperManipulator.getTemproraries());
			this.logService.log(
				LogService.LOG_INFO,
				"resource folder:\t"
					+ pepperManipulator.getResources());
			this.logService
				.log(LogService.LOG_INFO,
					"----------------------------------------------------");
		    }
	...
	{// emit all exporters and set them to job
		...
		if (this.logService != null) {
		    this.logService
			    .log(LogService.LOG_INFO,
				    "----------------------------------------------------");
		    this.logService.log(LogService.LOG_INFO,
			    "exporter name:\t\t" + exParams.getModuleName());
		    this.logService.log(
			    LogService.LOG_INFO,
			    "destination path:\t"
				    + exParams.getDestinationPath());
		    this.logService.log(LogService.LOG_INFO, "format name:\t\t"
			    + exParams.getFormatName());
		    this.logService
			    .log(LogService.LOG_INFO, "format version:\t\t"
				    + exParams.getFormatVersion());
		}
		PepperExporter pepperExporter = this.getPepperModuleResolver()
			.getPepperExporter(exParams);
		if (pepperExporter == null) {
			...
			this.logService
				.log(LogService.LOG_WARNING,
					"Cannot correct start job "
						+ jobParams.getId()
						+ ", because no exporter was found for: "
						+ exParams);
		} else {
		    CorpusDefinition corpusDefinition = PepperFWFactory.eINSTANCE
			    .createCorpusDefinition();
		    corpusDefinition.setCorpusPath(exParams
			    .getDestinationPath());
			...
			FormatDefinition formatDefinition = PepperFWFactory.eINSTANCE
				.createFormatDefinition();
			formatDefinition
				.setFormatName(exParams.getFormatName());
			formatDefinition.setFormatVersion(exParams
				.getFormatVersion());
			corpusDefinition.setFormatDefinition(formatDefinition);
		    }
			...
			if (exParams.getSpecialParams() != null) {
			    pepperExporter.setSpecialParams(exParams
				    .getSpecialParams());
			    setModuleProperties(pepperExporter,
				    exParams.getSpecialParams());
			}
		    }
		...
		if (this.logService != null) {
			...
			this.logService.log(
				LogService.LOG_INFO,
				"tmp folder:\t\t"
					+ pepperExporter.getTemproraries());
			this.logService.log(
				LogService.LOG_INFO,
				"resource folder:\t"
					+ pepperExporter.getResources());
			this.logService
				.log(LogService.LOG_INFO,
					"----------------------------------------------------");
		    }
	...
	if (pepperJob.getPepperExporters().size() < 1)
	    throw new PepperException("Cannot start job " + jobParams.getId()
		    + ", because no exporters were found.");
    ...
    /**
     * Loads and sets the module properties also called special params to a
     * {@link PepperModule}.
     * 
     * @param pepperModule
     * @param moduleProperties
     */
    private void setModuleProperties(PepperModule pepperModule,
	    URI moduleProperties) {
	if ((moduleProperties != null) && (pepperModule != null)) {
	...
	if (this.getPepperParams() == null)
	    throw new PepperParamsException("Cannot start with job " + id
		    + ". Please set pepper params first.");

	PepperJobParams currPepperJobParam = null;
	for (PepperJobParams pepperJobParam : this.getPepperParams()
		.getPepperJobParams()) {
	...
	SaltProject saltProject = SaltCommonFactory.eINSTANCE
		.createSaltProject();
	pepperJob.setSaltProject(saltProject);

	// create job 2 converter monitor
	PepperFinishableMonitor monitor = PepperFWFactory.eINSTANCE
		.createPepperFinishableMonitor();
	this.getPepperJ2CMonitors().add(monitor);
	pepperJob.setPepperJ2CMonitor(monitor);

	// start job
	if (this.isParallelized()) {// running jobs parallel
	    Thread jobThread = new Thread(pepperJob, "PepperConvertJob" + id);
	    jobThread.start();
	} else {// running jobs not parallel
	    pepperJob.start();
	}
    }
	...
	if (this.getPepperModuleResolver() == null)
	    throw new PepperException(
		    "Cannot start PepperConverter, because no 'PepperModuleResolver' is given.");
	if (this.logService != null)
	    this.logService.log(LogService.LOG_INFO, this
		    .getPepperModuleResolver().getStatus());

	if (this.getPepperParams() == null)
	    throw new PepperException(
		    "Cannot start converting. Please set pepper params first.");
	for (PepperJobParams pepperJobParam : this.getPepperParams()
		.getPepperJobParams()) {
	...
	case PepperFWPackage.PEPPER_CONVERTER__PEPPER_JOBS:
	    return ((InternalEList<?>) getPepperJobs()).basicRemove(otherEnd,
		    msgs);
	case PepperFWPackage.PEPPER_CONVERTER__PEPPER_J2C_MONITORS:
	    return ((InternalEList<?>) getPepperJ2CMonitors()).basicRemove(
		    otherEnd, msgs);
	}
	...
	case PepperFWPackage.PEPPER_CONVERTER__PEPPER_J2C_MONITORS:
	    ...
	    getPepperJ2CMonitors().addAll(
		    (Collection<? extends PepperFinishableMonitor>) newValue);
	    return;
	case PepperFWPackage.PEPPER_CONVERTER__PARALLELIZED:
	...
	case PepperFWPackage.PEPPER_CONVERTER__PEPPER_PARAMS:
	    return PEPPER_PARAMS_EDEFAULT == null ? pepperParams != null
		    : !PEPPER_PARAMS_EDEFAULT.equals(pepperParams);
	case PepperFWPackage.PEPPER_CONVERTER__PEPPER_JOBS:
	...
	case PepperFWPackage.PEPPER_CONVERTER__PEPPER_PARAMS_URI:
	    return PEPPER_PARAMS_URI_EDEFAULT == null ? pepperParamsURI != null
		    : !PEPPER_PARAMS_URI_EDEFAULT.equals(pepperParamsURI);
	}
