...
public class ModuleControllerImpl implements ModuleController{
	...
	/* (non-Javadoc)
	 * @see de.hu_berlin.german.korpling.saltnpepper.pepper.core.ModuleController#getId()
	 */
	@Override
	public String getId()
	{
	...
	/* (non-Javadoc)
	 * @see de.hu_berlin.german.korpling.saltnpepper.pepper.core.ModuleController#getPepperModule()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hu_berlin.german.korpling.saltnpepper.pepper.core.ModuleController#getJob()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hu_berlin.german.korpling.saltnpepper.pepper.core.ModuleController#setJob(de.hu_berlin.german.korpling.saltnpepper.pepper.core.PepperJobImpl)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hu_berlin.german.korpling.saltnpepper.pepper.core.ModuleController#setJob_basic(de.hu_berlin.german.korpling.saltnpepper.pepper.core.PepperJobImpl)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hu_berlin.german.korpling.saltnpepper.pepper.core.ModuleController#getInputDocumentBus()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hu_berlin.german.korpling.saltnpepper.pepper.core.ModuleController#setInputDocumentBus(de.hu_berlin.german.korpling.saltnpepper.pepper.core.DocumentBus)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hu_berlin.german.korpling.saltnpepper.pepper.core.ModuleController#getOutputDocumentBus()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hu_berlin.german.korpling.saltnpepper.pepper.core.ModuleController#setOutputDocumentBus(de.hu_berlin.german.korpling.saltnpepper.pepper.core.DocumentBus)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hu_berlin.german.korpling.saltnpepper.pepper.core.ModuleController#getSCorpusGraph()
	 */
	@Override
	...
	/** 
	 * Returns an executor service for this object. Executor, to create and manage threads for import of corpus structure and import of 
	 * document structure.
	 * @return
	 */
	...
	/* (non-Javadoc)
	 * @see de.hu_berlin.german.korpling.saltnpepper.pepper.core.ModuleController#importCorpusStructure(de.hu_berlin.german.korpling.saltnpepper.salt.saltCommon.sCorpusStructure.SCorpusGraph)
	 */
	@Override
	...
	/**
	 * A lock determining, whether this object currently is busy with 
	 * importing corpus structure or importing document structure.
	 * @return
	 */
	...
	/** 
	 * This set contains all {@link DocumentController} objects which have been requested by this 
	 * {@link ModuleControllerImpl} object or its {@link PepperModule} but have not been add to 
	 * output {@link DocumentBus} object.<br/>
	 * This list is used to control, if this {@link ModuleControllerImpl} object and its {@link PepperModule}
	 * work correctly.
	**/
	...
	/* (non-Javadoc)
	 * @see de.hu_berlin.german.korpling.saltnpepper.pepper.core.ModuleController#next()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.hu_berlin.german.korpling.saltnpepper.pepper.core.ModuleController#complete(de.hu_berlin.german.korpling.saltnpepper.pepper.core.DocumentController)
	 */
	@Override
...
//			throw new PepperConvertException("Cannot finish the given element-id, because the module-controller was not started (please call sytart() first).");
	...
	/* (non-Javadoc)
	 * @see de.hu_berlin.german.korpling.saltnpepper.pepper.core.ModuleController#delete(de.hu_berlin.german.korpling.saltnpepper.pepper.core.DocumentController)
	 */
	@Override
...
//			throw new PepperConvertException("Cannot finish the given element-id, because module-controller was not started.");
	...
	/* (non-Javadoc)
	 * @see de.hu_berlin.german.korpling.saltnpepper.pepper.core.ModuleController#getProgress(java.lang.String)
	 */
	@Override
