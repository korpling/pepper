 ...
 * {@link #createPepperMapper(SElementId)} method. The following snippet shows a dummy of that method:
 * <pre>
 ...
 *			}
 *		};
 *		// pass current file or folder to mapper. When using PepperImporter.importCorpusStructure or PepperExporter.exportCorpusStructure, the mapping between file or folder and SCorpus or SDocument was stored here
