...
public class TerminalDocumentBus extends DocumentBus
{
	...
	/**
	 * Creates an object of this type and sets all passed in- and output {@link ModuleControllerImpl} objects. 
	 * This is important, because an {@link DocumentController} can only be removed from queue, when all
	 * output {@link ModuleControllerImpl} objects requested the {@link DocumentController} object.  
	 ...
	 * (regarding the FIFO principle). When all registered {@link ModuleControllerImpl} objects
